 ...
 * Activate plugins
 *
 * This script activates all the required plugins
 *
 * @package    Functions
 * @subpackage Plugins
 * @version	   1.0
...
add_action( 'tgmpa_register', 'lp_register_required_plugins_portfolio' );
/**
 ...
 */
function lp_register_required_plugins_portfolio() {
	...
	$plugins = array(
		array(
			'name' 		=> 'LlamaPress Common Styles',
			'slug' 		=> 'llamapress-common-styles',
			'required' 	=> true,
	 ...
	 */
	$config = array(
		'domain'       		=> 'lp',         	// Text domain - likely want to be the same as your theme.
		...
		'message' 			=> 'This plugin rquires the below plugins in order to function as the theme demo.',							// Message to output right before the plugins table
		'strings'      		=> array(
